        ...
        <div className="grid grid-cols-12 font-roboto">
            <div className="grid col-span-4 grid-cols-4 h-max gap-y-[50px]">
                <div className="col-span-4 flex flex-col h-[150px] mt-[25px] justify-between">
                    ...
                    <p className="cursor-default col-span-4 text-center text-white font-bold text-[24px]">Sign up</p>
                </div>
                <div className="mt-[40px] col-span-4 text-center tracking-wider cursor-default text-white font-bold text-[16px]">Already have an account? <a className="cursor-pointer text-[#A70000] hover:italic"><Link to={'/login'}>Click here to Login</Link></a></div>
