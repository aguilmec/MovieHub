...
export default function SavedTab({ user, setUser }){
    ...
    return(
        <div className="grid grid-cols-10 col-span-10 col-start-2">
            <div className="flex col-span-8 col-start-2 mt-[50px] mb-[40px]">
            ...
            <div className="grid xl:grid-cols-6 lg:grid-cols-4 md:grid-cols-2 col-span-8 col-start-2 xl:gap-y-[30px] lg:gap-y-[30px] md:gap-y-[10px] sm:gap-y-[10px] xs:gap-y-[10px] gap-x-[20px] overflow-y-scroll h-[400px] scrollbar scrollbar-w-[2px] scrollbar-h-[2px] scrollbar-rounded-sm scrollbar-thumb-[#A7000055] scrollbar-opacity-50">
                {user.saved.length === 0 ? 
