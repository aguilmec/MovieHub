...
export default function VideoPlayer({ url }){
    ...
    return(
        <div onMouseLeave={()=>{setIsVisible(false)}} onMouseEnter={()=>{setIsVisible(true)}} className='mt-[100px] flex col-span-6 col-start-2 place-items-center xl:h-[480px] lg:h-[480px] md:h-[480px] relative'>
